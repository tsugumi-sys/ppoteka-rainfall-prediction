...
def main(data_dir_path: str):
    ...
    folder_path = os.path.join(data_dir_path, "cleaned-data")
                            ...
                            for data_folder in data_folders:
                                ...
                                if os.path.exists(data_file):
                                    ...
                                    if len(df) != 1440:
                                        ...
                                        imp_df = df.copy()
                                        imp_df = imp_df.fillna(
                                            method="bfill", axis=0, limit=3
                                        )
                                        imp_df = imp_df.fillna(
                                            method="ffill", axis=0, limit=3
                                        )
