...
class TestRainimgGenerator(unittest.TestCase):
    ...
    def test_gen_img(self):
        geoimg_generator = RainimgGenerator()
        ...
        min_val, max_val = MinMaxScalingValue.get_minmax_values_by_weather_param(WEATHER_PARAMS.RAIN.value)
