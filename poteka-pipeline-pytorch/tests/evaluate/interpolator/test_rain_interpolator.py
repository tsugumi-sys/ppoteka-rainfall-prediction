...
class TestRainInterpolator(unittest.TestCase):
    def __init__(self, methodName: str = ...) -> None:
        super().__init__(methodName)

        self.interpolator = RainInterpolator()

    def test_interpolate(self):
        """
        TODO: test with input tensor like one point that is located near the edge.
            And test the interpolate results checking the maximum value of one of
            the four quandrants and the maximum and minimum value of other three.
        """
